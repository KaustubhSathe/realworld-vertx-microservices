...
import static helloworld.GreeterGrpc.getServiceDescriptor;
...
public final class VertxGreeterGrpc {
    ...
    public static final class GreeterVertxStub extends io.grpc.stub.AbstractStub<GreeterVertxStub> {
        ...
        public io.vertx.core.Future<helloworld.HelloReply> sayHello(helloworld.HelloRequest request) {
    ...
    public static abstract class GreeterVertxImplBase implements io.grpc.BindableService {
        ...
        @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            helloworld.GreeterGrpc.getSayHelloMethod(),
                            asyncUnaryCall(
                                    new MethodHandlers<
